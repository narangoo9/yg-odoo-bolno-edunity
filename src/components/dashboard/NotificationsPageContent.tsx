...
const typeConfig: Record<NotificationType, { icon: ElementType; color: string }> = {
  ...
  FINAL_PROJECT_UNLOCKED: { icon: Award,      color: "text-violet-600 bg-violet-100 dark:bg-violet-500/15" },
  PROJECT_SUBMITTED:   { icon: BookOpen,      color: "text-blue-600 bg-blue-100 dark:bg-blue-500/15" },
  PEER_REVIEW_RECEIVED:{ icon: CheckCircle2,  color: "text-indigo-600 bg-indigo-100 dark:bg-indigo-500/15" },
  PROJECT_PASSED:      { icon: Award,         color: "text-emerald-600 bg-emerald-100 dark:bg-emerald-500/15" },
