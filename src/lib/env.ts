...
const envSchema = z.object({
  ...
  STRIPE_PRICE_STANDARD: optionalString,
...
export const env = {
  ...
  stripeStandardPriceId: raw.STRIPE_PRICE_STANDARD ?? "",
  stripePremiumPriceId: raw.STRIPE_PRICE_PREMIUM ?? "",
  stripeProPriceId: raw.STRIPE_PRICE_PRO ?? "",
